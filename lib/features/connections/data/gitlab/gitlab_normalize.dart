...
Ticket normalizeGitLabIssue(GitLabIssue e, {required String accountId}) {
  ...
  return Ticket(
    ...
    title: title,
    body: body,
    priority: mapGitLabPriority(e.labels),
    status: mapGitLabIssueStatus(state, e.labels),
    providerStatus: state,
    labels: List<String>.of(e.labels),
...
Ticket normalizeGitLabMergeRequest(
  ...
  return Ticket(
    ...
    body: body,
    priority: mapGitLabPriority(e.labels),
    status: mapGitLabMrStatus(state, e.draft, e.labels),
